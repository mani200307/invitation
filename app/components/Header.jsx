      ...
      <div className="navbar w-screen bg-base-100">
        <div className="navbar-start">
          ...
          <Link
            ...
            duration={500}
          >
            <h1 className="xs:text-xl cursor-pointer normal-case text-2xl w-52 ml-4">Manikandan T</h1>
          </Link>
        </div>
          ...
          <ul className="flex gap-3 px-1">
            <li>
              <Link
                ...
                offset={-70}
                duration={500}
                className='text-xl btn btn-ghost capitalize font-normal hover:bg-inherit'
              >
                Projects
              </Link>
            </li>
